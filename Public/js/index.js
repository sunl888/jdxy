...
window.setTimeout(function(){
	$('.photo').animate({'margin-top':-pic_height},800,
		function(){
			$(this).remove();
			$('.adver').show();
		});
...
$(function () {
    ...
    setTimeout(function () {
        ...
        $linkUl.css('width', link_width * link_count);
    },10)
    ...
    window.scroll = function() {
        scrollTimer = setInterval(function(){
            ...
            $('.imgLink ul').animate({'margin-left': -link_width},500, function () {
                var $first_img = $('.imgLink ul li').first();
                $first_img.remove();
                $('.imgLink ul').append($first_img);
                $('.imgLink ul').css('margin-left', 0);
            });
        },3000);
    };
    // scroll();
